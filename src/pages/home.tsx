        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-2xl">
            <h1 className="text-5xl font-bold mb-6">
              Professional Artificial Hair Care Services
            </h1>
            <p className="text-xl mb-8">
              Expert wig maintenance, conditioning, and cleaning with convenient
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <ProcessStep
              number="1"
              title="Book Service"
              description="Choose your service and schedule a pickup time"
            />
            <ProcessStep
              number="2"
              title="Pickup"
              description="We'll collect your hairpiece from your location"
            />
            <ProcessStep
              number="3"
              title="Service"
              description="Expert care and maintenance by our specialists"
            />
            <ProcessStep
              number="4"
              title="Delivery"
              description="Return delivery to your preferred location"
            />
          </div>
        </div>
      </section>
...
function ServiceCard({ icon, title, description, onClick }: any) {
  return (
    <div
...
function ContactInfo({ icon, title, info }: any) {
  return (
    <div className="text-center">
